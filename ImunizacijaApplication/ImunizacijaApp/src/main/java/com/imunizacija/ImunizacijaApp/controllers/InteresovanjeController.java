...
public class InteresovanjeController {
    ...
    public ResponseEntity<String> createNewInterest(@RequestBody Interesovanje interesovanje) {
        interesovanjeService.createNewInterest(interesovanje);
        return new ResponseEntity<>("Interesovanje uspjesno podneto!", HttpStatus.CREATED);
    }
}
